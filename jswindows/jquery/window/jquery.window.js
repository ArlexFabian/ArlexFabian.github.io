...
$.Window = (function()  {
	...
	var OPACITY_MINIMIZED = 0.8;    // css opacity while window minimized or doing animation
	var MINIMIZED_NARROW = 24;
	var MINIMIZED_LONG = 140;
	...
	var setting = {
		...
		animationSpeed: 300,            // [number:400] the speed of animations: maximize, minimize, restore, shift, in milliseconds
	...
	function constructor(caller, options) {
		...
		var options = $.extend({
			...
			width: 900,                   // [number:400] window width
			height: 600,                  // [number:300] window height
